...
export default {
  methods: {
    play() {
      // having a master timeline gives us more flexibility to add/remove specific timelines
      // this essentially breaks are timelines into smaller more manageable components
